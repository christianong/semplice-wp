			...
			if(!empty($projects)) {
				...
				foreach ($projects as $key => $project) {		
					...
					if($title_visibility == 'both') {
						$title = '
							<div class="post-title">' . $project['post_title'] . '<span class="' . $category_font . '">' . $project['project_type'] . '</span></div>
						'; 
					} else if($title_visibility == 'title') {
						$title = '
							<div class="post-title">' . $project['post_title'] . '</div>
						'; 
					} else if($title_visibility == 'category') {
						$title = '
							<div class="post-title"><span class="' . $category_font . '">' . $project['project_type'] . '</span></div>
						'; 
					}

					// link title if below
					if(false !== strpos($title_position, 'below')) {
						$title = '<a class="pg-title-link ' . $title_font . '" href="' . $project['permalink'] . '" title="' . $project['post_title'] . '">' . $title . '</a>';
					}
